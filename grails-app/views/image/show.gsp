...
<html>
	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<h1>${imageInstance.originalFilename}</h1>
			...
			<ol class="property-list image">			
				...
				<li class="fieldcontain">
					...
					<img src="${createLink(controller: 'image', action:'displayImage', id: imageInstance.id)}"/>
				</li>			
				</g:if>
				<g:if test="${imageInstance?.description}">
				<li class="fieldcontain">
					<span id="image-label" class="property-label">${imageInstance.description}</span>
				</li>
				</g:if>
			</ol>
